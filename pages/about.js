...
export default function about() {
  return (
    <div className="flex flex-col sm:flex-row-reverse  p-3 h-screen w-screen overflow-hidden">
      <div className="sm:w-1/2 p-5 h-100 rounded flex flex-col justify-center sm:justify-start items-center overflow-hidden">
        <Text style="Heading">
      ...
      <div className="p-5 sm:w-1/2 flex flex-col gap-y-5">
        <Text style="Heading">
        ...
        <Text style="Text">
          Energetic and Solution-driven Web Developer adept at contributing to
          ...
          applications from the ground up: information gathering, planning,
          design, development, testing, delivery, and maintenance. Passionate
          towards software architecture and design combined with sensitivity to
          serving the needs of the business balanced with the delivery of high
          quality solutions. seeking a career in Information Technology with a
          special interest in web design and development.
        </Text>
        <Text style="Text">
